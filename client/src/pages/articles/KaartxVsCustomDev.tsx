      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 md:py-16" style={{ maxWidth: '700px' }}>
        ...
        <div className="mt-16 p-8 bg-card rounded-2xl border-2">
          <h3 className="text-2xl font-bold text-foreground mb-4">
            Start smart. Launch fast.
          </h3>
          <p className="text-foreground leading-relaxed mb-6">
            Kaartx Kloud is built for founders who want to move quickly without cutting corners. Get seller onboarding, payouts, and GCC integrations out of the box.
          </p>
          <a href="/#booking">
            <Button size="lg" className="font-semibold" data-testid="button-talk-to-sales">
              Talk to Sales
            </Button>
          </a>
        </div>
