      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 md:py-16" style={{ maxWidth: '700px' }}>
        ...
        <div className="mt-16 p-8 bg-card rounded-2xl border-2">
          <h3 className="text-2xl font-bold text-foreground mb-4">
            Turn sellers into recurring revenue
          </h3>
          <p className="text-foreground leading-relaxed mb-6">
            Design your Starter, Growth, and Pro seller plans, configure them in Kaartx Kloud, and start building predictable MRR from day one.
          </p>
          <a href="/#booking">
            <Button size="lg" className="font-semibold" data-testid="button-design-seller-plans">
              Design your seller plans with Kaartx Kloud
            </Button>
          </a>
        </div>
        </article>
