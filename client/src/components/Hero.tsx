    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            <Button size="lg" className="shadow-playful group text-lg px-8 py-6 rounded-2xl font-bold hover:scale-[1.02] transition-transform" data-testid="button-hero-get-started">
              Start Building Your Marketplace
              <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="outline" className="backdrop-blur-sm text-lg px-8 py-6 rounded-2xl font-semibold border-2 hover:scale-[1.02] transition-transform" data-testid="button-hero-whatsapp">
