      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="relative bg-card/60 backdrop-blur-md rounded-3xl p-6 sm:p-7 lg:p-8 border-2 border-primary/20 shadow-lg hover:shadow-2xl hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative">
                  <div className="text-3xl sm:text-4xl lg:text-5xl font-black gradient-text mb-3 leading-none tracking-tight whitespace-nowrap" data-testid={`text-stat-value-${index}`}>
                    {stat.value}
                  </div>
