      ...
      <div className="mx-auto max-w-7xl px-5 py-12 sm:px-6">
        <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="col-span-1 md:col-span-2">
            ...
            >
              Launch and scale your multi-vendor marketplace with complete
              seller management, subscriptions, and GCC-ready integrations.
            </p>
            <div>
              <p
                className="mb-1 text-sm font-medium text-muted-foreground"
                data-testid="text-footer-business-label"
              >
                Business Inquiries:
              </p>
              <a
        ...
        {/* Contact Information */}
        <div className="mb-8 grid grid-cols-1 gap-8 border-t border-border pt-8 sm:grid-cols-3">
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          ...
          >
            © 2026 Kloud. All rights reserved. Powered by Kaartx.
          </p>
          <div className="flex gap-4">
            <a
              href="https://linkedin.com/company/kaartx-official"
              target="_blank"
            ...
            <a
              href="https://x.com/Kaartx_Official"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground transition-colors hover:text-primary"
